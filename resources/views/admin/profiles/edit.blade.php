...
@section('content')
        <div class="container-fluid">
            <h1 class="h3 mb-4 text-gray-800">Edit Profile
                <a href="{{ route('profiles.show', $profile->id) }}" class="d-block btn btn-primary btn-sm float-right">Return</a>
            </h1>
        </div>
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                    	@if ($errors)
	                    	...
	                    	@endforeach
                    	@endif
                    	<form action="{{ route('profiles.update', $profile->id) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    		@csrf
                    		@method('PUT')
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="first_name" id="first_name" value="{{ $profile->first_name }}" class="form-control" placeholder="First Name">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="last_name" id="last_name" value="{{ $profile->last_name }}" class="form-control" placeholder="Last Name">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="dob" id="dob" value="{{ $profile->dob }}" class="form-control" placeholder="Enter Date of Birth">
                                    @if ($errors->has('dob'))
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="address" id="address" value="{{ $profile->address }}"  class="form-control" placeholder="Enter Address">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="country" id="country" value="{{ $profile->country }}"  class="form-control" placeholder="Enter Country">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="state" id="state" value="{{ $profile->state }}"  class="form-control" placeholder="Enter State">
                                    @if ($errors->has('state'))
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="city" id="city" value="{{ $profile->city }}"  class="form-control" placeholder="Enter City">
                                    @if ($errors->has('city'))
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="zipcode" id="zipcode" value="{{ $profile->zipcode }}"  class="form-control" placeholder="Enter Zip Code">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="mobile_primary" id="mobile_primary" value="{{ $profile->mobile_primary }}"  class="form-control" placeholder="1234-1234567">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="mobile_secondary" id="mobile_secondary" value="{{ $profile->mobile_secondary }}"  class="form-control" placeholder="1234-1234567">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="phone" id="phone" value="{{ $profile->phone }}"  class="form-control" placeholder="Enter Landline Number">
                                    @if ($errors->has('phone'))
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="email_primary" id="email_primary" value="{{ $profile->email_primary }}"  class="form-control" placeholder="Email Primary">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="email_secondary" id="email_secondary" value="{{ $profile->email_secondary }}"  class="form-control" placeholder="Email Secondary">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="whatsapp" id="whatsapp" value="{{ $profile->whatsapp }}"  class="form-control" placeholder="Enter Whatsapp">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="facebook_profile" id="facebook_profile" value="{{ $profile->facebook_profile }}"  class="form-control" placeholder="Enter Facebook Profile">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="twitter_profile" id="twitter_profile" value="{{ $profile->twitter_profile }}"  class="form-control" placeholder="Enter Twitter Profile">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="linkedin_profile" id="linkedin_profile" value="{{ $profile->linkedin_profile }}"  class="form-control" placeholder="Enter Linkedin Profile">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="website" id="website" value="{{ $profile->website }}"  class="form-control" placeholder="Enter Website Url">
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="about" id="about" value="{{ $profile->about }}"  class="form-control" placeholder="Enter About">
                                    @if ($errors->has('about'))
						...
						@if ($profile->visibility == 'public' && empty(old()))
							checked
						@elseif (!empty(old()) && old('visibility') == 'on')
							checked
						checked
						@elseif (!empty(old()) && old('visibility') == 'on')
						checked
						@endif
						>
						<label for="visibility-checkbox" class="form-check-label">Visibility</label>
					</div>
					<input type="hidden" name="visibility" id="visibility" value="{{ $profile->visibility }}">
